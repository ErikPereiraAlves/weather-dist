...
public class WeatherClient {
	...
	public void populate(String pointType, int first, int third, int mean, int second, int count) {
		WebTarget path = collect.path("/weather/BOS/" + pointType);
		DataPoint dp = new DataPoint.Builder().withFirst(first).withThird(third).withMean(mean).withSecond(second)
	...
	public static void main(String[] args) {
		...
		System.out.println("....Java Software Architect test from ERIK PEREIRA ALVES...");
